...
- **Supplemental Reference**: `~/.config/agent-skills/references/performance-checklist.md` — detailed checklist with Core Web Vitals targets and measurement commands.
