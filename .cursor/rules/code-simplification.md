...
- **Protected Blocks**: The `simplify-ignore` hook (`~/.config/agent-skills/hooks/SIMPLIFY-IGNORE.md`) prevents the model from simplifying annotated code blocks — use for performance-critical or intentionally-unrolled sections.
